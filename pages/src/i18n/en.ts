...
export const en: TranslationKeys = {
  ...
  'hero.description': 'Delegate Edition: build ocr-delegate from source, install the agent skill, and let your host agent review code with its subscription LLM — zero npm, zero API keys on the OCR side.',
  ...
  'quickstart.subtitle': 'Build from source, install the agent skill, preview with ocr-delegate — your host agent handles the LLM review.',
  'quickstart.step1Title': 'Build & Install Skill',
  'quickstart.step1Desc': 'Compile ocr-delegate and install the delegate skill — no npm required.',
  'quickstart.step1Label1': 'Build and install',
  'quickstart.step1Label2': 'Verify installation',
  'quickstart.step2Title': 'Preview Files',
  'quickstart.step2Desc': 'List reviewable files and mode/ref metadata before running a review.',
  'quickstart.step2Label1': 'Workspace changes',
  'quickstart.step2Label2': 'Branch comparison',
  'quickstart.step3Title': 'Review with Your Agent',
  'quickstart.step3Desc': 'Resolve rules with ocr-delegate; your host agent performs the review.',
  'quickstart.step3Label1': 'Delegate commands',
  'quickstart.commentPreview': '# Preview reviewable files',
  'quickstart.commentBranch': '# Compare branches',
  'quickstart.commentRule': '# Resolve rules, then host agent reviews',
  'quickstart.upstreamNote': 'Upstream npm install (alibaba/open-code-review only):',
  'quickstart.upstreamLink': 'see docs →',
  ...
  'docs.configManualCustomNote': 'url and protocol are required for custom providers. Supported protocols: anthropic, openai, openai-responses.',
