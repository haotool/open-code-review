...
export const zh: TranslationKeys = {
  ...
  // Hero
  'hero.title': 'AI 代码审查\n百万真实任务验证',
  'hero.description': 'Delegate Edition：从源码构建 ocr-delegate、安装 Agent Skill，由宿主 Agent 使用订阅 LLM 完成审查 — 无需 npm，OCR 端无需 API Key。',
  ...
  'quickstart.subtitle': '从源码构建、安装 Agent Skill，用 ocr-delegate 预览 — 宿主 Agent 负责 LLM 审查。',
  'quickstart.step1Title': '构建并安装 Skill',
  'quickstart.step1Desc': '编译 ocr-delegate 并安装委托 Skill — 无需 npm。',
  'quickstart.step1Label1': '构建并安装',
  'quickstart.step1Label2': '验证安装',
  'quickstart.step2Title': '预览文件',
  'quickstart.step2Desc': '在运行审查前列出可审查文件及 mode/ref 元数据。',
  'quickstart.step2Label1': '工作区变更',
  'quickstart.step2Label2': '分支对比',
  'quickstart.step3Title': '由 Agent 执行审查',
  'quickstart.step3Desc': '用 ocr-delegate 解析规则；宿主 Agent 完成审查。',
  'quickstart.step3Label1': '委托命令',
  'quickstart.commentPreview': '# 预览可审查文件',
  'quickstart.commentBranch': '# 对比分支',
  'quickstart.commentRule': '# 解析规则后由宿主 Agent 审查',
  'quickstart.upstreamNote': '上游 npm 安装（仅限 alibaba/open-code-review）：',
  'quickstart.upstreamLink': '见文档 →',
  ...
  'docs.configManualCustomNote': '自定义供应商必须提供 url 和 protocol。支持的协议：anthropic、openai、openai-responses。',
