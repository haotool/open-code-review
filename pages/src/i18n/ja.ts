...
export const ja: TranslationKeys = {
  ...
  'hero.description': 'Delegate Edition：ソースから ocr-delegate をビルドし Agent Skill をインストール。ホスト Agent がサブスクリプション LLM でレビュー — npm 不要、OCR 側に API キー不要。',
  ...
  'quickstart.subtitle': 'ソースからビルドし Skill をインストール、ocr-delegate でプレビュー — LLM レビューはホスト Agent が担当。',
  'quickstart.step1Title': 'ビルドと Skill インストール',
  'quickstart.step1Desc': 'ocr-delegate をコンパイルし delegate skill をインストール — npm 不要。',
  'quickstart.step1Label1': 'ビルドとインストール',
  'quickstart.step1Label2': 'インストール確認',
  'quickstart.step2Title': 'ファイルをプレビュー',
  'quickstart.step2Desc': 'レビュー前に対象ファイルと mode/ref メタデータを一覧表示。',
  'quickstart.step2Label1': 'ワークスペース変更',
  'quickstart.step2Label2': 'ブランチ比較',
  'quickstart.step3Title': 'Agent でレビュー',
  'quickstart.step3Desc': 'ocr-delegate でルールを解決 — レビューはホスト Agent が実行。',
  'quickstart.step3Label1': 'デリゲートコマンド',
  'quickstart.commentPreview': '# レビュー対象ファイルをプレビュー',
  'quickstart.commentBranch': '# ブランチを比較',
  'quickstart.commentRule': '# ルール解決後、ホスト Agent がレビュー',
  'quickstart.upstreamNote': '上流 npm インストール（alibaba/open-code-review のみ）：',
  'quickstart.upstreamLink': 'ドキュメント →',
  ...
  'docs.configManualCustomNote': 'カスタムプロバイダーには url と protocol が必須です。サポートされるプロトコル：anthropic、openai、openai-responses。',
