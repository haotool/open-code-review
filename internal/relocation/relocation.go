// Package relocation holds the LLM-assisted comment re-location step,
// split out of internal/diff so the diff package stays free of
// llm/telemetry dependencies for delegate-only builds.
package relocation
